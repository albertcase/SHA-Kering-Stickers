<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/frontend/js/login.js"></script>
<div class="wrapper">
    <!--For the login page-->
    <div class="page page-1">
        <h2 class="p1-title">开云基金会长期致力于消除一切<br>
            针对于女性的暴力行为</h2>
        <p class="p1-des">
            在这一承诺与信念的指引下，我们推出BeHerVoice公益活动，以提升公众对消除对妇女暴力行为问题的认识。在赋权女性的道路上，我们需要更多人的支持。
        </p>
